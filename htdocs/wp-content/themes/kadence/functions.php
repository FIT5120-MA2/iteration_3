...
function portion_planner(){
	if(is_page(1551))
	{
		wp_enqueue_script('portionPlanner.js',"http://18.219.247.101/portionPlanner.js", array('jquery'),'',false);
	}
}
add_action('wp_enqueue_scripts','portion_planner');